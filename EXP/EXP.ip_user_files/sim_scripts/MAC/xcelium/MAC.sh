...
#
# Script generated by Vivado on Sun Jan 04 11:38:37 IST 2026
...
#
# Usage        : MAC.sh
#                MAC.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                MAC.sh [-reset_run]
#                MAC.sh [-reset_log]
#                MAC.sh [-help]
#
...
#                script (type 'MAC.sh -help' for more information).
#
...
# script info
echo -e "MAC.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./MAC.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.MAC xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.MAC -input simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/sk/Desktop/EcoAttention/EXP/EXP.cache/compile_simlib/xcelium"
  fi
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log MAC_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./MAC.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: MAC.sh [-help]\n\
Usage: MAC.sh [-step]\n\
Usage: MAC.sh [-lib_map_path]\n\
Usage: MAC.sh [-reset_run]\n\
Usage: MAC.sh [-reset_log]\n\
Usage: MAC.sh [-keep_index]\n\
Usage: MAC.sh [-noclean_files]\n\n\
