...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.MAC xil_defaultlib.glbl -o MAC_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./MAC_simv $vcs_sim_opts -do simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/sk/Desktop/EcoAttention/EXP/EXP.cache/compile_simlib/vcs"
  fi
...
reset_run()
{
  files_to_remove=(ucli.key MAC_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc MAC_simv.daidir vcs_lib c.obj)
