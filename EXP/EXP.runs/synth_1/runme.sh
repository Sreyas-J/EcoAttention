...
HD_PWD='/home/sk/Desktop/EcoAttention/EXP/EXP.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log exp_fixed.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source exp_fixed.tcl
