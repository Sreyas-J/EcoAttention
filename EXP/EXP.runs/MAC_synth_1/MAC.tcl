...
synth_design -top MAC -part xc7a15tcpg236-1 -incremental_mode off -mode out_of_context
...
set_param constraints.enableBinaryConstraints false
 ...
 if { [get_msg_config -count -severity {CRITICAL WARNING}] == 0 } {
  config_ip_cache -add -dcp MAC.dcp -move_files $ipCachedFiles   -synth_runtime $TIME_taken  -ip [get_ips MAC]
 }
...
create_report "MAC_synth_1_synth_report_utilization_0" "report_utilization -file MAC_utilization_synth.rpt -pb MAC_utilization_synth.pb"
