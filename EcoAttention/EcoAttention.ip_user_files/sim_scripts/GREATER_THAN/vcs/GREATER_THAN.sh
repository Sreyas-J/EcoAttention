...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.GREATER_THAN xil_defaultlib.glbl -o GREATER_THAN_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./GREATER_THAN_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key GREATER_THAN_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc GREATER_THAN_simv.daidir vcs_lib c.obj)
