...
#
# Script generated by Vivado on Mon Aug 25 18:43:58 IST 2025
# SW Build 4029153 on Fri Oct 13 20:13:54 MDT 2023
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2023 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : GREATER_THAN.sh
...
#
# Usage        : GREATER_THAN.sh
#                GREATER_THAN.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                GREATER_THAN.sh [-reset_run]
#                GREATER_THAN.sh [-reset_log]
#                GREATER_THAN.sh [-help]
#
...
#                script (type 'GREATER_THAN.sh -help' for more information).
#
...
# script info
echo -e "GREATER_THAN.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./GREATER_THAN.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.GREATER_THAN xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.GREATER_THAN -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log GREATER_THAN_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./GREATER_THAN.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: GREATER_THAN.sh [-help]\n\
Usage: GREATER_THAN.sh [-step]\n\
Usage: GREATER_THAN.sh [-lib_map_path]\n\
Usage: GREATER_THAN.sh [-reset_run]\n\
Usage: GREATER_THAN.sh [-reset_log]\n\
Usage: GREATER_THAN.sh [-keep_index]\n\
Usage: GREATER_THAN.sh [-noclean_files]\n\n\
