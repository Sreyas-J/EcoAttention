...
#
# Script generated by Vivado on Tue Aug 26 19:26:37 IST 2025
...
#
# Usage        : MUL.sh
#                MUL.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                MUL.sh [-reset_run]
#                MUL.sh [-reset_log]
#                MUL.sh [-help]
#
...
#                script (type 'MUL.sh -help' for more information).
#
...
# script info
echo -e "MUL.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./MUL.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.MUL xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.MUL -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log MUL_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
Usage: MUL.sh [-reset_log]\n\
Usage: MUL.sh [-keep_index]\n\
