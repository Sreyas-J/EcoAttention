...
#
# Script generated by Vivado on Mon Aug 18 21:34:11 IST 2025
...
# script info
echo -e "MUL.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb MUL.wdb xsim.dir libdpi.so)
