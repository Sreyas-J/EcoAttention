...
#
# Script generated by Vivado on Mon Aug 18 22:35:35 IST 2025
...
#
# Usage        : DIV.sh
#                DIV.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                DIV.sh [-reset_run]
#                DIV.sh [-reset_log]
#                DIV.sh [-help]
#
...
#                script (type 'DIV.sh -help' for more information).
#
...
# script info
echo -e "DIV.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./DIV.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.DIV xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.DIV -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log DIV_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
Usage: DIV.sh [-reset_log]\n\
Usage: DIV.sh [-keep_index]\n\
