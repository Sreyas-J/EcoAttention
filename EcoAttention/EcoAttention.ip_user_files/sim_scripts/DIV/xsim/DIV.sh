...
#
# Script generated by Vivado on Mon Aug 11 22:03:21 IST 2025
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb DIV.wdb xsim.dir libdpi.so)
