...
#
# Script generated by Vivado on Wed Aug 13 19:11:04 IST 2025
...
#
# Usage        : Q.sh
#                Q.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                Q.sh [-reset_run]
#                Q.sh [-reset_log]
#                Q.sh [-help]
#
...
#                script (type 'Q.sh -help' for more information).
#
...
# script info
echo -e "Q.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./Q.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.Q xil_defaultlib.glbl -o Q_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./Q_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key Q_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc Q_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./Q.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: Q.sh [-help]\n\
Usage: Q.sh [-step]\n\
Usage: Q.sh [-lib_map_path]\n\
Usage: Q.sh [-reset_run]\n\
Usage: Q.sh [-reset_log]\n\
Usage: Q.sh [-keep_index]\n\
Usage: Q.sh [-noclean_files]\n\n\
