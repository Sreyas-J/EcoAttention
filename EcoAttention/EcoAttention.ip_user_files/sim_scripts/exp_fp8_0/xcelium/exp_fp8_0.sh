...
#
# Script generated by Vivado on Wed Jan 07 21:27:12 IST 2026
# SW Build 4029153 on Fri Oct 13 20:13:54 MDT 2023
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2023 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : exp_fp8_0.sh
...
#
# Usage        : exp_fp8_0.sh
#                exp_fp8_0.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                exp_fp8_0.sh [-reset_run]
#                exp_fp8_0.sh [-reset_log]
#                exp_fp8_0.sh [-help]
#
...
#                script (type 'exp_fp8_0.sh -help' for more information).
#
...
# script info
echo -e "exp_fp8_0.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./exp_fp8_0.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  ...
  xmvhdl -work axi_utils_v2_0_7 -V93 $xmvhdl_opts \
  ...
  xmvhdl -work xbip_dsp48_multadd_v3_0_7 -V93 $xmvhdl_opts \
  "../../../ipstatic/MAC/hdl/xbip_dsp48_multadd_v3_0_vh_rfs.vhd" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvhdl.log 2>/dev/null

  xmvhdl -work xbip_bram18k_v3_0_7 -V93 $xmvhdl_opts \
  "../../../ipstatic/MAC/hdl/xbip_bram18k_v3_0_vh_rfs.vhd" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvhdl.log 2>/dev/null

  xmvhdl -work mult_gen_v12_0_19 -V93 $xmvhdl_opts \
  "../../../ipstatic/MAC/hdl/mult_gen_v12_0_vh_rfs.vhd" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvhdl.log 2>/dev/null

  xmvhdl -work floating_point_v7_1_16 -V93 $xmvhdl_opts \
  ...
  xmvlog -work xil_defaultlib $xmvlog_opts -sv \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.exp_fp8_0 xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.exp_fp8_0 -input simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/sk/Desktop/EcoAttention/EcoAttention/EcoAttention.cache/compile_simlib/xcelium"
  fi
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log exp_fp8_0_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./exp_fp8_0.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: exp_fp8_0.sh [-help]\n\
Usage: exp_fp8_0.sh [-step]\n\
Usage: exp_fp8_0.sh [-lib_map_path]\n\
Usage: exp_fp8_0.sh [-reset_run]\n\
Usage: exp_fp8_0.sh [-reset_log]\n\
Usage: exp_fp8_0.sh [-keep_index]\n\
Usage: exp_fp8_0.sh [-noclean_files]\n\n\
