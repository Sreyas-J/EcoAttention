...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.exp_fp8_0 xil_defaultlib.glbl -o exp_fp8_0_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./exp_fp8_0_simv $vcs_sim_opts -do simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/sk/Desktop/EcoAttention/EcoAttention/EcoAttention.cache/compile_simlib/vcs"
  fi
...
reset_run()
{
  files_to_remove=(ucli.key exp_fp8_0_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc exp_fp8_0_simv.daidir vcs_lib c.obj)
