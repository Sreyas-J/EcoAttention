...
#
# Script generated by Vivado on Mon Aug 18 22:36:26 IST 2025
# SW Build 3865809 on Sun May  7 15:04:56 MDT 2023
#
# Tool Version Limit: 2023.05 
#
# Filename     : GREATERthan.sh
...
#
# Usage        : GREATERthan.sh
#                GREATERthan.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                GREATERthan.sh [-reset_run]
#                GREATERthan.sh [-reset_log]
#                GREATERthan.sh [-help]
#
...
#                script (type 'GREATERthan.sh -help' for more information).
#
...
design_libs=(simprims_ver xpm xbip_utils_v3_0_10 axi_utils_v2_0_6 xbip_pipe_v3_0_6 xbip_dsp48_wrapper_v3_0_4 xbip_dsp48_addsub_v3_0_6 xbip_dsp48_multadd_v3_0_6 xbip_bram18k_v3_0_6 mult_gen_v12_0_18 floating_point_v7_1_15 xil_defaultlib)

# simulation root library directory
sim_lib_dir="xcelium_lib"

# script info
echo -e "GREATERthan.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./GREATERthan.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  ...
  xmvhdl -work floating_point_v7_1_15 -V93 $xmvhdl_opts \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.GREATERthan xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.GREATERthan -input simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/dell/Desktop/projects/RISCVextension/EcoAttention/EcoAttention.cache/compile_simlib/xcelium"
  fi
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log GREATERthan_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./GREATERthan.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: GREATERthan.sh [-help]\n\
Usage: GREATERthan.sh [-step]\n\
Usage: GREATERthan.sh [-lib_map_path]\n\
Usage: GREATERthan.sh [-reset_run]\n\
Usage: GREATERthan.sh [-reset_log]\n\
Usage: GREATERthan.sh [-keep_index]\n\
Usage: GREATERthan.sh [-noclean_files]\n\n\
