...
design_libs=(xpm xbip_utils_v3_0_10 axi_utils_v2_0_6 xbip_pipe_v3_0_6 xbip_dsp48_wrapper_v3_0_4 xbip_dsp48_addsub_v3_0_6 xbip_dsp48_multadd_v3_0_6 xbip_bram18k_v3_0_6 mult_gen_v12_0_18 floating_point_v7_1_15 xil_defaultlib)
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.GREATERthan xil_defaultlib.glbl -o GREATERthan_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./GREATERthan_simv $vcs_sim_opts -do simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/dell/Desktop/projects/RISCVextension/EcoAttention/EcoAttention.cache/compile_simlib/vcs"
  fi
...
reset_run()
{
  files_to_remove=(ucli.key GREATERthan_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc GREATERthan_simv.daidir vcs_lib c.obj)
