...
#
# Script generated by Vivado on Mon Aug 11 22:29:44 IST 2025
...
#
# Usage        : K.sh
#                K.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                K.sh [-reset_run]
#                K.sh [-reset_log]
#                K.sh [-help]
#
...
#                script (type 'K.sh -help' for more information).
#
...
# script info
echo -e "K.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./K.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.K xil_defaultlib.glbl -o K_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./K_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key K_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc K_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./K.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: K.sh [-help]\n\
Usage: K.sh [-step]\n\
Usage: K.sh [-lib_map_path]\n\
Usage: K.sh [-reset_run]\n\
Usage: K.sh [-reset_log]\n\
Usage: K.sh [-keep_index]\n\
Usage: K.sh [-noclean_files]\n\n\
