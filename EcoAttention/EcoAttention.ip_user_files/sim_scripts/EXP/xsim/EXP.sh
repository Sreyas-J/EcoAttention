...
#
# Script generated by Vivado on Mon Aug 11 22:06:56 IST 2025
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb EXP.wdb xsim.dir libdpi.so)
