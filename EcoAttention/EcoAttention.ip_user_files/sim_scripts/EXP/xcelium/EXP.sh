...
#
# Script generated by Vivado on Mon Aug 18 22:36:05 IST 2025
...
#
# Usage        : EXP.sh
#                EXP.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                EXP.sh [-reset_run]
#                EXP.sh [-reset_log]
#                EXP.sh [-help]
#
...
#                script (type 'EXP.sh -help' for more information).
#
...
# script info
echo -e "EXP.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./EXP.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.EXP xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.EXP -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log EXP_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./EXP.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: EXP.sh [-help]\n\
Usage: EXP.sh [-step]\n\
Usage: EXP.sh [-lib_map_path]\n\
Usage: EXP.sh [-reset_run]\n\
Usage: EXP.sh [-reset_log]\n\
Usage: EXP.sh [-keep_index]\n\
Usage: EXP.sh [-noclean_files]\n\n\
