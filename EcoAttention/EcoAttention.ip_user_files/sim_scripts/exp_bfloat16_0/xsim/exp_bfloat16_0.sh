...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xbip_utils_v3_0_11 -L axi_utils_v2_0_7 -L xbip_pipe_v3_0_7 -L xbip_dsp48_wrapper_v3_0_5 -L xbip_dsp48_addsub_v3_0_7 -L xbip_dsp48_multadd_v3_0_7 -L xbip_bram18k_v3_0_7 -L mult_gen_v12_0_19 -L floating_point_v7_1_16 -L xil_defaultlib -L uvm -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot exp_bfloat16_0 xil_defaultlib.exp_bfloat16_0 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim exp_bfloat16_0 -key {Behavioral:sim_1:Functional:exp_bfloat16_0} -tclbatch cmd.tcl -log simulate.log
}
...
map_local_libs()
{
  ...
  local_libs=(xbip_utils_v3_0_11 axi_utils_v2_0_7 xbip_pipe_v3_0_7 xbip_dsp48_wrapper_v3_0_5 xbip_dsp48_addsub_v3_0_7 xbip_dsp48_multadd_v3_0_7 xbip_bram18k_v3_0_7 mult_gen_v12_0_19 floating_point_v7_1_16)
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb exp_bfloat16_0.wdb xsim.dir libdpi.so)
