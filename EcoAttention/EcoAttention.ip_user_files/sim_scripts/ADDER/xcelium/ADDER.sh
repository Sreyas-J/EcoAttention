...
#
# Script generated by Vivado on Mon Aug 18 22:35:07 IST 2025
...
#
# Usage        : ADDER.sh
#                ADDER.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                ADDER.sh [-reset_run]
#                ADDER.sh [-reset_log]
#                ADDER.sh [-help]
#
...
#                script (type 'ADDER.sh -help' for more information).
#
...
# script info
echo -e "ADDER.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./ADDER.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.ADDER xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.ADDER -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log ADDER_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
Usage: ADDER.sh [-reset_log]\n\
Usage: ADDER.sh [-keep_index]\n\
