...
HD_PWD='/home/sk/Desktop/EcoAttention/EcoAttention/EcoAttention.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log axis_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source axis_wrapper.tcl
